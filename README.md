...
The car should be maneuvered manually by a user via a joystick in the app. The joystick should allow the user to easily adjust the speed and direction that the Medcar is travelling at. The joystick provides a better range of motion, allowing for more precise movements when necessary.
