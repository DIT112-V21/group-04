...
namespace arduino_car{
    ...
    TEST_F(SimpleCarConnectsTest, registerManualControl_WhenCalled_WillSubscribeToCorrectChannels){ // _F means we dont need to repeat instatiation of all the mocks.
